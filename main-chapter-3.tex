...
To determine the most suitable algorithm for route optimization in the mobile application, a comparative analysis will be conducted on several metaheuristic algorithms commonly used for solving the TSP. The evaluation will be conducted using benchmark datasets from TSPLIB, a well-known library of sample instances for the TSP and related problems. The analysis will focus on descriptive performance metrics, specifically the solution quality and runtime efficiency of each algorithm.
