...
This study primarily focuses on the development and implementation of a mobile application that generates personalized itineraries for tourists. The research design is structured so that the system is developed based on empirical evidence and is evaluated for its quality, standards, and acceptability among users and professionals in the tourism industry.
