...
The pseudocode for each of the algorithms is shown in Appendix A.
...
The respondents of this study consist of two distinct groups: (1) end-users (individual tourists) who had visited or were visiting tourist destinations in Bulacan, and (2) IT professionals for evaluating the technical quality of Lakad. The tourists are the primary users of the application, while the IT professionals are the secondary users who evaluate the technical aspects of the system. 

\textbf{Population Definition.} The population for end-user evaluation was operationalized as individual tourists aged 18 years or older who had either visited or were actively visiting tourist destinations across the 25 municipalities in Bulacan during the data collection period. It is important to note that the 8,023,618 visitor arrivals documented in Table \ref{tourist_arrivals} represent cumulative annual arrivals rather than unique individual tourists; therefore, this figure served as a reference for municipal classification rather than as a direct population parameter for sample size calculations. 

\textbf{End-Users: Sampling Design.} End-users, comprising tourists visiting Bulacan, were the primary respondents for Technology Acceptance Model (TAM) evaluation. A two-stage purposive and convenience-based sampling approach was employed, as described below. 

First, municipalities in Bulacan were classified according to their 2025 tourist arrivals (low, medium, high) based on the data provided by PHACTO. 
...
In the second stage, tourists within the selected municipalities were recruited through convenience sampling at active tourist attraction sites. The selected municipalities for the study were Baliwag, Bocaue, Bustos, Calumpit, Guiguinto, Malolos, Marilao, Plaridel, Pulilan, and San Rafael. These ten municipalities were chosen purposively to represent a range of tourist arrival classifications (low, medium, high), thereby ensuring that the eventual sample would reflect the diversity of tourists visiting different areas of Bulacan. Within these selected municipalities, respondents were allocated proportionately based on the tourist arrivals of each municipality. This proportional allocation ensures that the sample composition approximates the actual distribution of tourist arrivals across the selected municipalities.

\textbf{Selection Methodology and Inherent Biases.} Data were collected through face-to-face administration at various tourist attraction sites during the survey period. This convenience-based recruitment approach, while practical for reaching mobile tourist populations, introduces several important biases and limitations that must be acknowledged: (1) \textit{availability bias}—respondents who were available and accessible at tourist sites may differ from tourists who avoid crowded areas; (2) \textit{self-selection bias}—tourists willing to invest time completing a survey may have stronger opinions about technology than non-respondents; (3) \textit{temporal bias}—the sample reflects only tourists present during data collection dates and times, potentially excluding different seasonal visitor profiles; and (4) \textit{measurement reactivity}—on-site application demonstration followed by immediate questionnaire completion may artificially elevate or depress ratings compared to naturalistic usage. These limitations are inherent to convenience sampling and should be considered when interpreting findings regarding tourist technology acceptance. 

\textbf{Sample Size Determination.} A total sample size of 150 end-users was determined through a pragmatic approach balancing statistical rigor and logistical feasibility. For finite population proportions with a 95\% confidence level ($z = 1.96$), assuming $p = 0.5$ (maximum variance) and a 5\% margin of error ($E = 0.05$), the standard formula yields:

\begin{equation}
	n = \frac{z^2 p(1-p)}{E^2} = \frac{(1.96)^2 (0.5)(0.5)}{(0.05)^2} \approx 384 \text{ respondents}
\end{equation}

However, acknowledging practical constraints in conducting in-person surveys with mobile tourist populations, the target sample size was reduced to 150 respondents. This adjustment corresponds to a margin of error of approximately 7.9\% at the 95\% confidence level, calculated as:

\begin{equation}
	E = z \sqrt{\frac{p(1-p)}{n}} = 1.96 \sqrt{\frac{(0.5)(0.5)}{150}} \approx 0.079
\end{equation}

This reduced sample size remains acceptable for TAM evaluation studies. According to guidance from \textcite{Memon2020} based on Roscoe's (1975) rules of thumb, sample sizes of 30 to 500 are appropriate for most behavioral research, and TAM studies typically require 30 or more respondents per construct. With 150 respondents, this study achieves approximately 37--50 respondents per TAM construct, providing adequate statistical power. A post-hoc power analysis using G*Power 3.1 with $\alpha = 0.05$ and effect size $f^2 = 0.15$ (medium effect) indicates that 150 respondents yields statistical power of approximately 0.92 for path model analysis, exceeding the conventional threshold of 0.80.
...
\textbf{IT Professionals: Purposive Sampling and Expert Selection.} IT professionals evaluated the technical quality of Lakad using ISO/IEC 25010:2023 standards through purposive sampling. A total of 22 IT experts were deliberately selected based on their professional qualifications and relevant experience. The sample comprised: (1) software engineers and quality assurance professionals with minimum 2 years of experience in mobile application development ($n \approx 12$); (2) UI/UX designers specializing in mobile interfaces ($n \approx 5$); and (3) faculty members from The College of Information and Communications Technology (CICT) at Bulacan State University (BulSU) with expertise in software quality or systems evaluation ($n \approx 5$). Purposive sampling was appropriate for expert evaluation, as the goal was to ensure participants possessed requisite technical knowledge rather than statistical representativeness of a broader population. In addition to quantitative ISO/IEC 25010:2023 assessment, IT professionals were also invited to provide qualitative feedback on the system's strengths and areas for improvement based on their technical expertise.
...
\textbf{Data Collection Timeline.} The data collection process was conducted over a four-month period, from [Month/Year] to [Month/Year], spanning seasonal variations in tourist arrivals. Data from end-users were collected on weekdays and weekends at multiple time intervals (morning, afternoon, and evening) at various tourist destinations to minimize temporal sampling bias.

\textbf{Preparation and Pilot Testing.} Before the actual data collection, a formal permission was requested and obtained from the local government units (LGUs) of the selected municipalities to conduct the survey among tourists. After obtaining the necessary permissions, pilot testing was conducted to ensure the reliability and validity of the TAM questionnaire. The pilot test was done with a small group of respondents who were similar to the target population. A total of 20 respondents from the municipality of Pandi were selected for the pilot test because it is excluded from the main data collection to avoid bias. Cronbach's alpha was computed on the pilot test results to verify internal consistency and reliability of the adapted TAM questionnaire. The calculated Cronbach's alpha coefficient of 0.881 exceeded the acceptability threshold of 0.70, indicating good internal consistency across TAM items and reliability for measuring user technology acceptance within this study's context. 

While the ISO/IEC 25010:2023 is a standardized international quality evaluation framework, formal validation was not conducted with a separate pilot sample. However, the instrument was reviewed with two senior faculty members from CICT to ensure appropriateness of the quality criteria for evaluating mobile itinerary generation applications and to verify clarity of the assessment items. This validity review, while less rigorous than full pilot testing, provided assurance that the standardized instrument could be meaningfully applied to Lakad's specific functionality.

\textbf{Administration to End-users.} The data collection for end-users employed convenience sampling methods at high-traffic tourist attraction sites across the selected municipalities in Bulacan. Researchers stationed at predetermined popular tourist destinations approached tourists and presented them with informed consent information, after which willing participants were invited to take part in the survey. The survey protocol included: (1) a brief introduction to Lakad's core features and functionalities; (2) approximately 10--15 minutes of guided application exploration on research-provided tablets; and (3) completion of the TAM questionnaire assessing perceived usefulness, ease of use, attitude towards the system, and behavioral intention to use. The evaluation process was conducted immediately following application exploration to capture first-impression responses. Demographic information including age bracket, traveling frequency, and technological proficiency was collected to enable post-hoc analysis of potential correlations with TAM construct scores. Respondents were allocated across collection sites proportionally to match the municipal allocation targets shown in Table \ref{endusers}. While this convenience-based approach ensured practical feasibility and adequate sample size achievement, readers should note the selection bias limitations acknowledged in the Sampling Design section.  
