...
\textbf{Preparation and Pilot Testing.} Before the data collection, a formal permission was requested and obtained from the local government units (LGUs) of the selected municipalities to conduct the survey among tourists. After obtaining the necessary permissions, a pilot test was conducted to ensure the reliability and validity of the TAM questionnaire. The pilot test was done with a small group of respondents who were similar to the target population. A total of 20 respondents from the municipality of Pandi were selected for the pilot test, a municipality excluded from the main data collection to avoid bias. The pilot results were analyzed to calculate the Cronbach's alpha for the TAM questionnaire, which yielded a value of 0.881, indicating good internal consistency and reliability of the instrument for measuring user acceptance in this context. For the ISO/IEC 25010:2023, since it is a standardized evaluation method, a pilot test was not conducted for this instrument. 
...
The data collected from the surveys was organized and encoded in software such as Microsoft Excel and Jamovi for analysis. Descriptive statistics was used to summarize the data. Since this study employs a 5-point Likert scale for both TAM and ISO/IEC 25010:2023 evaluations, the median and mode were the primary measures of central tendency used to interpret the respondents' perceptions and evaluations. 


TODO: Media and Mode interpretation for TAM and ISO/IEC 25010:2023 results.
