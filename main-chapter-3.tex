...
\textbf{End-users.} The population for end-user evaluation was defined through its operationalization as all individual tourists who were 18 years or older and who had visited or were currently visiting tourist sites in all 25 municipalities of Bulacan during the data collection period. The visitor arrivals documented in Table \ref{tourist_arrivals} reached a total of 8,023,618 because this figure counted all yearly visitor arrivals instead of unique individual tourists; thus, this number functioned as a reference point for municipal classification instead of serving as a direct population parameter that researchers used to calculate sample sizes.

\textbf{End-Users: Sampling Design.} The Technology Acceptance Model (TAM) assessment required tourists who visited Bulacan as its main study participants. The research team used a two-stage sampling method which combined purposive and convenience sampling techniques according to the established procedure.
...
The researchers collected data by conducting surveys with participants at various tourist sites throughout the duration of the study. The recruitment method based on convenience helps researchers access tourist populations. However, this method also introduces potential biases that need to be acknowledged. One is that respondents who were available and accessible at tourist sites may differ from tourists who avoid crowded areas. The sample reflects only tourists present during data collection dates and times, potentially excluding different seasonal visitor profiles. The process of showing application demonstrations at the site before completing their questionnaires may lead to different rating outcomes than what actual usage would produce. Researchers acknowledge these limitations and have taken steps to mitigate them, such as ensuring a diverse range of tourist sites and times for data collection. 

A sample size of 150 respondents was determined for the end-user evaluation while considering the practical constraints of data collection and the need for a manageable sample size to draw results. The researchers consider this sample size sufficient given the limited resources, time constraints, and logistical challenges associated with collecting data from tourists at various sites across multiple municipalities. 
