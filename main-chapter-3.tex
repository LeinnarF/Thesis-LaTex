...
The number of samples for the end-users will be estimated using Cochran’s formula \ref{cochran}, due to large and unknown population of tourists. The target sample size for the end-users is at least 100 to sufficient responses for TAM. 
\begin{equation}
    \label{cochran}
