...
To determine the best algorithm to implement for Lakad, a comparative benchmarking was conducted using four standard instances from the TSPLIB library, detailed in Table \ref{tsplib_instace}.
...
The algorithm with the lowest score was the selected route optimization algorithm for Lakad.
...
Lakad integrates six major features designed to provide optimized, personalized, and efficient itinerary planning for tourists exploring Bulacan. Each feature combines techniques, verified local data, and user-centric design principles.
\begin{enumerate}
