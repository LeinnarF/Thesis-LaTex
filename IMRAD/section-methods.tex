...
Data processing and analysis were executed using Python libraries (Pandas, NumPy). Because the questionnaire responses are ordinal, descriptive statistics were utilized to determine central tendencies and variances. Construct-level measures were obtained by computing the mean composite scores and standard deviations for all respondents. For both the TAM and ISO/IEC 25010:2023 instruments, the 5-point rating scales were standardized such that a mean score between 4.21 and 5.00 corresponds to a descriptive interpretation of "Highly Acceptable" (for TAM) or "Excellent" (for ISO/IEC).
