...
Figure \ref{kanban} shows a graphical representation of a Kanban workflow model. Kanban method is use because of its effective visual process management. It optimizes the workflow and allows the researchers to track the progress of developement. \textcite{Alaidaros2021} highlighted that Kanban operates on the Just In Time principle, meaning tasks are completed and delivered while maximizing efficiency. Kanban’s adaptability allows the team to adjust priorities and reallocate resources as needed. This flexibility is key to maintaining momentum and delivering a high-quality software output \parencite{Risener2022}.
