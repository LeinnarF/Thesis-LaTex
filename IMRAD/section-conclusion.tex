...
The developed system successfully solves both trip planning problems and the inconsistent promotion of tourist spots in Province of Bulacan. This study proved that data-driven tools improve tourism accessibility for local areas when using mathematical optimization models together with modern mobile technologies. 
