...
The software quality of the LAKAD application was evaluated using a survey based on the ISO/IEC 25010:2023 software quality model. The survey was done by IT experts, Software developers, and selected faculty members in the College of Information and Communications Technology (CICT) of Bulacan State University. The survey was initially distributed to 20 respondents, but now additional 2 respondents were added to the evaluation, making a total of 22 respondents. 
...
\begin{table}[H]
	\centering
	\singlespacing
	\caption{Functional Suitability Median and Frequency Scores}
    \label{tab:isoa}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} \\
		\midrule
		Functional Completeness & 5 & 0 & 0 & 0 & 4 & 18 \\
		Functional Correctness & 5 & 0 & 0 & 0 & 3 & 19 \\
		Functional Appropriateness & 5 & 0 & 0 & 0 & 2 & 20 \\
		\bottomrule
	\end{tabularx}
\end{table}

Table \ref{tab:isoa} shows the per item median scores and frequency distributions for the Functional Suitability construct. All items achieved a median score of 5, indicating that respondents rated the functional aspects of the LAKAD application very high. The majority of respondents rated each item as 4 or 5, with the highest frequency of 5s for Functional Appropriateness (20 respondents). The low frequency of ratings below 4 indicates that there were very few concerns regarding the functional suitability of the application among the respondents.

\begin{table}[H]
	\centering
	\singlespacing
	\caption{Performance Efficiency Median and Frequency Scores}
    \label{tab:isob}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Time Behavior & 5 & 0 & 0 & 0 & 5 & 17 \\
		Resource Utilization & 5 & 0 & 0 & 0 & 6 & 16 \\
		Capacity & 5 & 0 & 0 & 0 & 4 & 18 \\
		\bottomrule
	\end{tabularx}
\end{table}

Table \ref{tab:isob} presents the results for the Performance Efficiency construct. Similar to Functional Suitability, all items achieved a median score of 5, indicating that the application was optimized for performance and resource utilization. The majority of respondents rated Time Behavior, Resource Utilization, and Capacity as 4 or 5, with the highest frequency of 5s for Capacity (18 respondents). The low frequency of ratings below 4 suggests that there were minimal concerns regarding the performance efficiency of the application among the respondents.


\begin{table}[H]
	\centering
	\singlespacing
	\caption{Compatibility Median and Frequency Scores}
    \label{tab:isoc}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Co-existence & 5 & 0 & 0 & 0 & 6 & 16 \\
		Interoperability & 5 & 0 & 0 & 2 & 5 & 15 \\
		\bottomrule
	\end{tabularx}
\end{table}

The reason for the lower mean score for Compatibility in Table \ref{iso1} can be further explored in Table \ref{tab:isoc}. Some evaluators share the same sentiments regarding the exclusivity of the app to Android devices, which limits its compatibility with other platforms. This is reflected in the frequency distribution. But still, the majority of the respondents rated both Co-existence and Interoperability as 4 or 5, with the highest frequency of 5s for Co-existence (16 respondents). The presence of some ratings below 4 indicates that there were some concerns regarding the compatibility of the application among a few respondents, likely due to the platform exclusivity issue.  

\begin{table}[H]
	\centering
	\singlespacing
	\caption{Interaction Capability Median and Frequency Scores}
    \label{tab:isod}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Appropriateness Recognizability & 5 & 0 & 0 & 0 & 3 & 19 \\
		Learnability & 5 & 0 & 0 & 0 & 4 & 18 \\
		Operability & 5 & 0 & 0 & 0 & 4 & 18 \\
		User Error Protection & 5 & 0 & 0 & 1 & 6 & 15 \\
		User Engagement & 5 & 0 & 0 & 0 & 6 & 16 \\
		Inclusivity & 5 & 0 & 0 & 0 & 5 & 17 \\
		User Assistance & 5 & 0 & 0 & 1 & 5 & 16 \\
		Self-Descriptiveness & 5 & 0 & 0 & 0 & 5 & 17 \\
		\bottomrule
	\end{tabularx}
\end{table}

Table \ref{tab:isod} explores the Interaction Capability construct, which focuses on the user interaction aspects of the application. All items achieved a median score of 5, indicating that respondents rated the interaction capabilities of the LAKAD application very high. The Appropriateness Recognizability, Learnability, and Operability items had the highest frequency of 5s, indicating that IT experts supported that users found the application to be intuitive and easy to learn. This supports the high scores for Perceived Ease of Use in the TAM survey. 

\begin{table}[H]
	\centering
	\singlespacing
	\caption{Reliability Median and Frequency Scores}
    \label{tab:isoe}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Faultlessness & 5 & 0 & 0 & 1 & 1 & 20 \\
		Availability & 5 & 0 & 0 & 1 & 2 & 19 \\
		Fault Tolerance & 5 & 0 & 0 & 1 & 4 & 17 \\
		Recoverability & 5 & 0 & 0 & 0 & 3 & 19 \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{table}[H]
	\centering
	\singlespacing
	\caption{Security Median and Frequency Scores}
    \label{tab:isof}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Confidentiality & 5 & 0 & 0 & 1 & 3 & 18 \\
		Integrity & 5 & 0 & 0 & 0 & 4 & 18 \\
		Non-repudiation & 5 & 0 & 0 & 0 & 5 & 17 \\
		Accountability & 5 & 0 & 0 & 0 & 1 & 21 \\
		Authenticity & 5 & 0 & 0 & 0 & 3 & 19 \\
		Resistance & 5 & 0 & 0 & 1 & 3 & 18 \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{table}[H]
	\centering
	\singlespacing
	\caption{Maintainability Median and Frequency Scores}
    \label{tab:isog}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Modularity & 5 & 0 & 0 & 0 & 8 & 14 \\
		Reusability & 5 & 0 & 0 & 0 & 7 & 15 \\
		Analysability & 5 & 0 & 0 & 1 & 9 & 12 \\
		Modifiability & 5 & 0 & 0 & 0 & 7 & 15 \\
		Testability & 5 & 0 & 0 & 0 & 2 & 20 \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{table}[H]
	\centering
	\singlespacing
	\caption{Flexibility Median and Frequency Scores}
    \label{tab:isoh}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Adaptability & 5 & 0 & 0 & 0 & 5 & 17 \\
		Scalability & 5 & 0 & 0 & 0 & 4 & 18 \\
		Installability & 5 & 0 & 0 & 0 & 4 & 18 \\
		Replaceability & 5 & 0 & 0 & 0 & 9 & 13 \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{table}[H]
	\centering
	\singlespacing
	\caption{Safety Median and Frequency Scores}
    \label{tab:isoi}
	\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\linewidth}{>{\hsize=3.5\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X >{\hsize=.583\hsize}X}
		\toprule
		...
		& & 1 & 2 & 3 & 4 & 5 \\
		\midrule
		Operational Constraint & 5 & 0 & 0 & 0 & 3 & 19 \\
		Risk Identification & 5 & 0 & 0 & 1 & 4 & 17 \\
		Fail-Safe & 5 & 0 & 0 & 1 & 6 & 15 \\
		Hazard Warning & 5 & 0 & 0 & 1 & 4 & 17 \\
		Safe Integration & 5 & 0 & 0 & 1 & 3 & 18 \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{figure}
    \centering
    \caption{Frequency distribution of ISO/IEC 25010:2023 responses}
    \begin{subfigure}[H]{0.3\textwidth}
        \centering
