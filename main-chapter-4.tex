...
\begin{figure}[H]
    ...
    \begin{subfigure}[H]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{evaluation/pu.png}}
    ...
    \begin{subfigure}[H]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{evaluation/peou.png}} 
    ...
    \begin{subfigure}[H]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{evaluation/au.png}}
    ...
    \begin{subfigure}[H]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{evaluation/bi.png}}
