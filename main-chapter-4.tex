...
\begin{table}[H]
	...
	\begin{tabularx}{\linewidth}{XXXXXX}
		\toprule
        \multirow{2}{*}{\textbf{Algorithm}} & \multicolumn{4}{c}{\textbf{TSPLIB Instances}} & \multirow{2}{*}{\textbf{Growth Trend}} \\
        \cmidrule(lr){2-5}
         & \textbf{burma14} & \textbf{bays29} & \textbf{eil51} & \textbf{berlin52} &  \\
		\midrule
        EHO     & 0.17 & 0.27   & 0.44      & 0.45    & Very Low \\
        SA      & 0.49 & 1.04   & 1.82      & 1.90    & Low \\
        GWO     & 0.51 & 1.02   & 1.73      & 1.75    & Low\\ 
        HSFFPKO & 1.16 & 1.42   & 1.78      & 1.76    & Moderate \\
        PSO     & 3.36 & 4.77   & 6.30      & 6.84    & Moderate \\
        ACO     & 2.51 & 9.67   & 28.62     & 29.23   & High \\
        GA      & 3.79 & 26.31  & 168.15    & 196.59    & Exponential\\
		\bottomrule
	\end{tabularx}
\end{table}
