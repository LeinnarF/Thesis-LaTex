...
The standard deviations offer further insight into the experts’ evaluations, ranging tightly from 0.2447 to 0.4973. Notably, Functional Suitability achieved the lowest standard deviation of 0.2447 alongside the highest mean, representing near-unanimous agreement among the IT experts regarding the app’s capability to deliver on its core features. Conversely, Compatibility showed the highest standard deviation at 0.4973, reflecting slightly more variance in expert opinion—likely a direct result of the varying subjective weights experts place on cross-platform availability versus current Android performance. Overall, the consistent, low variance across all categories confirms a reliable expert consensus, culminating in a grand ISO/IEC 25010:2023 score of 4.7642.
