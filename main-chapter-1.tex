...
The system was developed using the React Native framework which enables developers to create applications that work on multiple platforms.However, the deployment of the system is only limited to Android Operating System because of resource limitations. To be able to develop in iOS  it needed to have access to macOS hardware and an Apple Developer account which was not possible in this study. 
