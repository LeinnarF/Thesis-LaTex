...
developed by \textcite{Yochum2020} as a recommender algorithm to ensure that itinerary destination suggestions does not merely list POIs, but instead consider user preferences.
